...
REM ============================================================
REM OHPAC Reporting and Analytics -> Oracle Copy
REM ============================================================

set "SOURCE=C:\Users\ssanders\Documents\GitHub\my_obsidian_vault\Work\Projects\OHPAC\Reporting and Analytics"
set "DEST=C:\Users\ssanders\OneDrive - stonybrookmedicine\Oracle\Reporting and Analytics"
...
REM Example: 2026-08-14_131700
REM ------------------------------------------------------------
for /f %%I in ('powershell -NoProfile -Command "Get-Date -Format yyyy-MM-dd_HHmmss"') do set "TIMESTAMP=%%I"

set "LOGFILE=%LOGDIR%\Oracle_Copy_%TIMESTAMP%.log"

REM ------------------------------------------------------------
REM Write header
REM ------------------------------------------------------------
echo ============================================================ > "%LOGFILE%"
echo OHPAC Oracle File Copy >> "%LOGFILE%"
...
>>>>>>> 729db1242e29a1e2b385b5f766cf1af0dc92df90
endlocal